  ...
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content">
        <h2 class="content-title" @click="isShowNotic=true">
    ...
    <div class="shop-header-discounts">
      <div class="discounts-left">
        <div class="activity activity-green">
          ...
          <span @click="isShowDiscount=true" class="activity-content">新用户下单立减17元</span>
        </div>
      </div>
    ...
    <div class="shop-brief-modal" v-show="isShowNotic">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isShowNotic=false"></span>
        </div>
      </div>
      <div class="brief-modal-cover" @click="isShowNotic=false"></div>
    </div>
